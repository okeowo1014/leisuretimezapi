    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_id",
                    models.IntegerField(help_text="Original PK of the deleted user"),
                ),
                ...
                (
                    "reason",
                    models.TextField(
                        blank=True, default="User-requested account deletion"
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        default="default.svg", upload_to="profile/images/"
                    ),
                ),
                (
                    "status",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="destination_images",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "booking",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="index.booking"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "bookings",
                    models.ManyToManyField(
                        blank=True, related_name="packages", to="index.booking"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="saved_by", to="index.package"
            ),
        ),
        migrations.CreateModel(
            name="PackageImage",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "invoice",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="index.invoice"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "notes",
                    models.TextField(
                        blank=True, default="", help_text="Customisation details"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(upload_to="personalised_booking/attachments/"),
                ),
                (
                    "category",
                    models.CharField(
