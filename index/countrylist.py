# Static dataset of all countries with their ISO2 codes, country names, and continents
country_data = {
    ...
    'CD': {'name': 'Congo, Democratic Republic of the', 'continent': 'Africa'},
    ...
    'LA': {'name': 'Lao Peoples Democratic Republic', 'continent': 'Asia'},
    ...
    'SH': {'name': 'Saint Helena, Ascension and Tristan da Cunha', 'continent': 'Africa'},
...
def get_country_info(iso2_code):
    """
    Returns the country name and continent for the given ISO2 country code.
    
    :param iso2_code: The ISO2 country code (e.g., 'US' for United States)
    :return: A tuple (country_name, continent) or None if the code is not found
    """
    info = country_data.get(iso2_code.upper(), None)
    if info:
        return info['name'], info['continent']
    return None

# # Example usage:
# print(get_country_info('US'))  # Output: ('United States of America', 'North America')
# print(get_country_info('GB'))  # Output: ('United Kingdom of Great Britain and Northern Ireland', 'Europe')
# print(get_country_info('IN'))  # Output: ('India', 'Asia')
# print(get_country_info('ng'))  # Output: None (invalid code)
